...
*/
    ...
    //Setting the fonts of all the text in this activity 
 	public void setFonts()
 	{
          ...
          inputFirstName.setTypeface(blockFonts);
          inputLastName.setTypeface(blockFonts);
          inputEmail.setTypeface(blockFonts);
          inputPassword.setTypeface(blockFonts);
          inputUsername.setTypeface(blockFonts);
         ...
         // b1.setTypeface(blockFonts);
          ...
          b5.setTypeface(blockFonts);
          b6.setTypeface(blockFonts);
          b7.setTypeface(blockFonts);
