...
private static String KEY_ERROR = "error";
  ...
  TextView textView2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bktolog = (Button) findViewById(R.id.bktolog);
        setFonts();
	...
	public void setFonts()
	{
        ...
        textView2.setTypeface(blockFonts);
        alert.setTypeface(blockFonts);
        resetpass.setTypeface(blockFonts);
        bktolog.setTypeface(blockFonts);
	}
